    ...
    */
    ...
    public List<FoodEntry> getByIngredient(List<String> foodList) {
        ...
        for (String food : foodList) {
            ...
            getDirect(food, incompList);
            getByCate(getCategory(food), incompList);
            result.add(new FoodEntry(food, incompList));
        }
        return result;
    }

    public void getDirect(String food, List<String> result) {
        try {
            ...
            while (foodlist.next()) {
                result.add(foodlist.getString("name2"));
            }
    ...
    public void getByCate(String category, List<String> result) {
        try {
